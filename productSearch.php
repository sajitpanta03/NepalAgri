		...
		<!-- Footer -->
			...
			<div class="footer-center">
				<div>
					...
					<p style="font-size:20px">GoldenGate Int'l College<span>Old Baneshwor</span></p>
				</div>
				<div>
				...
				<div>
					...
					<p style="font-size:20px"><a href="mailto:sajit@gmail.com" style="color:white">sajit@gmail.com</a></p>
				</div>
			</div>
